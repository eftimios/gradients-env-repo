"""
Manual Goofspiel Evaluation Script
Based on: https://github.com/gradients-ai/G.O.D/blob/affine-GAME-environments/scripts/manual_environment_eval.py

This script evaluates trained models on Goofspiel against MCTS opponent.
Evaluation matches tournament conditions: 250 episodes against MCTS.
"""
...
OPPONENT_TYPE = "mcts"  # Tournament uses MCTS opponent
NUM_EVALS = 250  # Tournament standard: 250 episodes
TEMPERATURE = 0.0
RANDOM_SEED = 42
...
def run_evaluation():
    ...
    try:
        ...
        print("🚀 Starting AgentGym Server (Goofspiel)...")
        ...
        print(f"Game: {GAME_TO_EVAL}, Opponent: {OPPONENT_TYPE}\n")
        completed = 0
        ...
        print(f"\nTournament Evaluation Conditions:")
        print(f"  - Game: {GAME_TO_EVAL}")
        print(f"  - Opponent: {OPPONENT_TYPE}")
        print(f"  - Episodes: {NUM_EVALS}")
